...
<html>
  <head>
	...
	<link rel="stylesheet" href="{{asset('css/buyer/contact.css')}}">
    <!-- Fontawesome icon -->
  ...
  <body>
    ...
    <section class = "contact-section">
	  ...
	  <img   class = "contact-bg" src="{{asset('assets/buyer/contact-bg.jpg')}}" >
      ...
      <div class = "contact-body">
        ...
        <div class = "contact-form">
          ...
          <div>
		  <img src="{{asset('assets/buyer/contact-png.png')}}" >
